...
// class activityDBProvider {
//   activityDBProvider._();
//   static final activityDBProvider db = activityDBProvider._();
...
//   newReward(Activity newReward) async {
//     final db = await database;
...
//     return res.isNotEmpty ? Activity.fromMap(res.first) : null;
//   }

//   updateReward(Activity newReward) async {
//     final db = await database;
